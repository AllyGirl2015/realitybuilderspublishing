...
export default function SpaceBackground() {
  ...
  useLayoutEffect(() => {
    ...
    const seed = hashString('rbew-entertainment-space-2025-11-19-1');
    ...
    class Nebula {
      ...
      constructor() {
        ...
        if (this.color.includes('138, 43, 226')) {
          this.opacity = random() * 0.1 + 0.05;
        }
    ...
    for (let i = 0; i < nebulaCount; i++) {
      ...
      if (i < 3) {
        // Blue nebulas
        nebula.color = 'rgba(0, 243, 255, 0.15)';
        nebula.opacity = random() * 0.3 + 0.1;
      } else {
        // Weak purple nebula
        nebula.color = 'rgba(138, 43, 226, 0.08)';
        nebula.opacity = random() * 0.1 + 0.05;
      }
      nebulas.push(nebula);
    }
